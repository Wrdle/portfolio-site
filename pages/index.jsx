      ...
      <div id="about-me"
        ...
        <div className="basis-full lg:basis-1/2">
          ...
          <p>Hi there, I'm Matt, and I'm a software engineer at Suncorp Bank. I work with Kafka, Kotlin,
            SpringBoot and React to make the bank's daily operations run smoothly through eventing
            pipelines.
            <br/><br/>
            I have a genuine enthusiasm for Software Engineering, and I'm always on the lookout for new
            technologies
            to get my hands dirty with. When I'm not glued to my laptop screen, you can usually find me at
            the gym or
            spending time with my partner.
            <br/><br/>
            I believe that passion is the key to success, and I'm passionate about my work. I love nothing
            more than
...
function Footer() {
  return <div className="bg-[#10101a] text-center py-14">
