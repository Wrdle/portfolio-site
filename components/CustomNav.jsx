        ...
        <div>
            <Navbar className={NavStyles.CustomNav} variant="dark" bg="dark" expand="lg" sticky="top">
                ...
                <Navbar.Collapse className={NavStyles.NotTransparent}>
                    ...
                    <Form inline>
                        <Nav.Link href="https://github.com/Wrdle" className={NavStyles.social_icon}><AiFillGithub /></Nav.Link>
                        <Nav.Link href="https://www.linkedin.com/in/matt-dagostino/" className={NavStyles.social_icon}><IoLogoLinkedin /></Nav.Link>
                    </Form>
                </Navbar.Collapse>
            </Navbar>
        </div>
